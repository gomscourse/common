...
//go:generate minimock -i github.com/gomscourse/common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/gomscourse/common/pkg/db"
)
...
type TxManagerMock struct {
	...
	funcReadCommitted          func(ctx context.Context, handler mm_db.Handler) (err error)
	inspectFuncReadCommitted   func(ctx context.Context, handler mm_db.Handler)
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, handler mm_db.Handler) *mTxManagerMockReadCommitted {
	...
	mmReadCommitted.defaultExpectation.params = &TxManagerMockReadCommittedParams{ctx, handler}
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, handler mm_db.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, handler mm_db.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, handler mm_db.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
	...
	expectation := &TxManagerMockReadCommittedExpectation{
		...
		params: &TxManagerMockReadCommittedParams{ctx, handler},
	}
...
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, handler mm_db.Handler) (err error) {
	...
	if mmReadCommitted.inspectFuncReadCommitted != nil {
		mmReadCommitted.inspectFuncReadCommitted(ctx, handler)
	}

	mm_params := TxManagerMockReadCommittedParams{ctx, handler}
	...
	if mmReadCommitted.ReadCommittedMock.defaultExpectation != nil {
		...
		mm_got := TxManagerMockReadCommittedParams{ctx, handler}
	...
	if mmReadCommitted.funcReadCommitted != nil {
		return mmReadCommitted.funcReadCommitted(ctx, handler)
	}
	mmReadCommitted.t.Fatalf("Unexpected call to TxManagerMock.ReadCommitted. %v %v", ctx, handler)
	return
}
